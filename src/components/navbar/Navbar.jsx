...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-50">
      ...
      <div className="flex active:scale-95 text-lg font-medium relative flex-col gap-0"><Link className="h-full w-full text-web-dark duration-300   inline-block" to="/cart">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
