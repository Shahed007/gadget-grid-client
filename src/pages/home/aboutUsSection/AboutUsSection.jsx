...
const AboutUsSection = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto px-3  flex flex-col md:flex-row gap-6 items-center ">
      ...
      <div className="flex-1">
        <h3 className="text-2xl text-web-dark font-medium mb-3">About TechWonders</h3>
        <p className="text-base">At TechWonders, we're passionate about technology and innovation. Our mission is to bring you the latest and greatest in the world of gadgets, electronics, and tech wonders.</p>
